...
import Teste.com.teste.Controller.RaceController;
...
public class RaceTest {
    ...
    public void shouldReturn201_WhenRegisteringRace() throws Exception {
		Race ct = new Race("{ \"year\": \"2009\" }")
    ...
    public void shouldReturn500_WhenFailedRegisteringRace() throws Exception {
		Race ct = new Race("{ \"year\": \"2009\" }")
    ...
    public void shouldReturn404_WhenCallNotFoundRace() throws Exception {
		Race ct = new Race("{ \"year\": \"2009\" }")
